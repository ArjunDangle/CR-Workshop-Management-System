// client/src/modules/incident/components/dashboards/SSEOfficeIncidentDashboard.tsx
...
export const SSEOfficeIncidentDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold">Incident Status Overview</CardTitle>
        </CardHeader>
        <CardContent>
